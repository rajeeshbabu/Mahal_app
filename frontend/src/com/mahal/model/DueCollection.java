...
public class DueCollection {
    ...
    public Long getDueTypeId() { return dueTypeId; }
    public void setDueTypeId(Long dueTypeId) { this.dueTypeId = dueTypeId; }
    
    public String getDueTypeName() { return dueTypeName; }
    public void setDueTypeName(String dueTypeName) { this.dueTypeName = dueTypeName; }
